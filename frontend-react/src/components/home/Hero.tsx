    ...
    <section className="bg-primary/90 relative w-full py-20 md:py-32">
      <div className="container mx-auto flex items-center justify-between gap-10 px-20">
        ...
        <div className="w-full max-w-130 space-y-2 text-start">
          <p className="text-popover text-5xl leading-[1.2] font-bold">Kuasai Teknologi Masa Depan Bersama Komunitas.</p>
          ...
          <div className="pt-5">
            <Button className="bg-popover text-primary rounded-[10px] px-6 py-6 text-lg leading-[1.2] font-semibold" variant="secondary">
              Pelajari Sekarang
            </Button>
          </div>
        </div>
        ...
        <div className="pointer-events-none select-none">
          ...
          <img src="/pinguin.png" loading="lazy" width={800} height={800} alt="Doscom Mascot" className="absolute right-10 bottom-0 z-10 -mb-39.5 object-cover 2xl:right-80" />
        </div>
