  ...
  return (
    <>
      <div
        ...
        className={cn(
          'sticky top-0 z-10 flex flex-wrap items-center gap-1 border-b border-slate-200 bg-white/95 px-2 backdrop-blur-sm',
          compact ? 'py-1.5' : 'py-2',
        )}
      >
        <ToolbarGroup>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                size="sm"
                className={cn(
                  'gap-1.5 text-slate-600 hover:bg-slate-100 hover:text-slate-900',
            ...
            <DropdownMenuContent align="start" className="min-w-[11rem]">
              <DropdownMenuLabel className="text-xs text-slate-500">Media & elemen</DropdownMenuLabel>
        ...
        <Popover>
          ...
          <PopoverContent align="start" className="w-72 gap-0 rounded-xl p-0 shadow-md ring-slate-200">
