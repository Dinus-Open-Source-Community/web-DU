...
export const manageDetailLayout = {
  ...
  pageBottomMobile: 'pb-36 lg:pb-0',
  sectionCard:
  ...
  tabList:
    'inline-flex h-auto w-max min-w-full flex-nowrap justify-start gap-0 rounded-none border-b border-slate-200 bg-transparent p-0',
  tabTrigger:
    'relative -mb-px !flex-none inline-flex min-h-10 shrink-0 items-center gap-1.5 rounded-none border-b-2 border-transparent px-3 pb-2.5 pt-2 text-sm font-medium text-slate-500 transition-colors after:!hidden data-active:border-primary data-active:text-slate-900 sm:px-4',
