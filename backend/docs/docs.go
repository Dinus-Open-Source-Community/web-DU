...
const docTemplate = `{
    ...
    "paths": {
        "/admin/dashboard/kpis": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Period: 7d, 30d, 90d, 12m (default 30d)",
                        "name": "period",
                        "in": "query"
                    }
                ],
        ...
        "/admin/qna": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by course UID",
                        "name": "courseUid",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "Q\u0026A threads retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateCourseQaReplyRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Q\u0026A reply created successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/admin/reviews": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Filter reviews with replies",
                        "name": "has_reply",
                        "in": "query"
                    },
                    {
        ...
        "/admin/transactions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search by reference, course, or student",
                        "name": "search",
                        "in": "query"
                    },
                    {
        ...
        "/courses/{id}/assignments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by assignment status (DRAFT, TERBIT, DITUTUP)",
                        "name": "status",
                        "in": "query"
                    }
                ],
        ...
        "/courses/{id}/mentors/unassign": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Mentor UIDs to remove",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Mentors unassigned successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/courses/{id}/progress": {
            "get": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Access denied: must be enrolled in this course",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateCourseQaThreadRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Q\u0026A thread created successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/courses/{id}/qna/{thread_id}/replies": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/lessons/readings/lesson/{lesson_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Lesson readings retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Failed to retrieve lesson readings",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/lessons/readings/my-history": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to retrieve reading history",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/lessons/{id}/assignment/submission": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "submissions array + attempt metadata",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/lessons/{id}/read": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Enrollment UID (optional, auto-resolved if omitted)",
                        "name": "enrollment_id",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Reading status retrieved",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Failed to retrieve reading status",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Lesson already marked as read (existing record returned)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "201": {
                        "description": "Lesson marked as read successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "403": {
                        "description": "Access denied: must be enrolled in the course",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Failed to mark lesson as read",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/mentor/dashboard/kpis": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Mentor dashboard KPIs retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/mentor/dashboard/schedules": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Include past schedules (default: false)",
                        "name": "include_past",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "Mentor schedules retrieved successfully",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/payment/method": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Kode metode pembayaran (e.g. BRIVA, OVO, QRIS2)",
                        "name": "name",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "file",
                        "description": "File gambar/logo metode pembayaran (opsional)",
                        "name": "image",
                        "in": "formData"
                    }
                ],
    ...
    "definitions": {
        ...
        "dto.CreateCourseQaReplyRequest": {
            "type": "object",
            "required": [
                "body"
            ],
        ...
        "dto.CreateCourseQaThreadRequest": {
            "type": "object",
            "required": [
                "body",
                "title"
