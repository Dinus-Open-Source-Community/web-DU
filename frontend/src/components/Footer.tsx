        ...
        <div className="bg-card rounded-xl border border-blue-500/20 px-8 py-12 backdrop-blur-sm sm:px-12">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="text-center md:text-left">
              <h2 className="text-primary text-4xl font-bold sm:text-3xl">
            ...
            >
              ...
              <Button
                type="submit"
                className="bg-primary rounded-md px-7 py-5 text-white"
              >
                Subscribe
              </Button>
            </form>
      ...
      <div className="mx-auto max-w-400 px-32 pt-8 pb-12">
        <div className="flex flex-col gap-8 md:flex-row md:justify-between">
          ...
          <div className="shrink-0 md:max-w-lg">
            <Link
              href="/"
              className="text-primary text-[26px] font-bold whitespace-pre"
            >
              Doscom University
            </Link>
                ...
                <ul className="mt-4 space-y-3">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-popover/70 hover:text-popover text-sm transition"
                      >
                        {link.label}
                      </Link>
                    </li>
