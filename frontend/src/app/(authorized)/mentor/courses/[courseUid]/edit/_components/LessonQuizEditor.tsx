...
import type { IQuiz, IQuizQuestion, IQuizOption } from '@/lib/types'
  ...
  return (
    <div className="space-y-5">
            ...
            <div className="flex-1 space-y-2">
              ...
              <div className="pl-6">
                <input
                  ...
                  value={q.explanation ?? ''}
                  onChange={(e) =>
                    updateQuestion(q.id, (x) => ({ ...x, explanation: e.target.value || undefined }))
                  }
      ...
      <Button
        ...
        size="sm"
        onClick={addQuestion}
        className="w-full rounded-xl border-dashed border-slate-300 bg-transparent text-xs"
      >
