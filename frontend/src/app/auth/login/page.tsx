  ...
  return (
    <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white p-6 md:p-10">
      ...
      <div className="absolute bottom-0 left-0 z-0 pointer-events-none select-none">
        <Image src={bunderImg} alt="Circle Decoration" className="w-72 object-contain opacity-90 md:w-[500px]" priority />
      </div>
      ...
      <div className="relative z-10 grid min-h-[800px] w-full max-w-[1324px] grid-cols-1 items-center rounded-[60px] border border-white/20 bg-white/30 shadow-2xl shadow-blue-100/20 backdrop-blur-[50px] lg:grid-cols-2">
          ...
          <div className="flex w-full max-w-[434.4px] flex-col gap-[38px]">
            ...
            <form className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                ...
                <input type="email" placeholder="username@gmail.com" className="h-[51.87px] w-full rounded-[5.19px] border border-gray-300 bg-white px-4 text-sm text-[#333333] outline-none placeholder:text-gray-400 focus:border-[#2582E1] focus:ring-1 focus:ring-[#2582E1]" />
              </div>
              ...
              <div className="flex flex-col gap-2" style={{ height: '82.99px' }}>
                ...
                <div className="relative h-[51.87px] w-full">
                  <input type="password" placeholder="Password" className="h-full w-full rounded-[5.19px] border border-gray-300 bg-white px-4 pr-10 text-sm text-[#333333] outline-none placeholder:text-gray-400 focus:border-[#2582E1] focus:ring-1 focus:ring-[#2582E1]" />
                  <EyeOff className="absolute right-4 top-1/2 h-5 w-5 -translate-y-1/2 cursor-pointer text-gray-400" />
                </div>
              </div>

              <button type="button" className="h-[41.49px] w-full rounded-[4.61px] bg-[#2582E1] text-sm font-medium text-white transition-colors hover:bg-blue-600 shadow-md shadow-blue-200">
                Sign In
              </button>
            </form>

            <div className="flex flex-col items-center gap-6">
              <span className="text-[18.15px] font-normal text-[#333333]">Or Continue With</span>
              ...
              <div className="flex items-center gap-1">
                <span className="text-[18.15px] text-[#333333]">Don’t have an account yet?</span>
                <a href="/auth/register" className="text-[18.15px] text-[#1F84E6] hover:underline">Register for free</a>
              </div>
            </div>
        ...
        <div className="absolute z-20 hidden lg:block" style={{ width: '200px', height: '200px', top: '60px', left: '650px' }}>
          <Image src={shurikenImg} alt="Shuriken Decoration" fill className="object-contain drop-shadow-[0_0_15px_rgba(37,130,225,0.6)]" />
        </div>

        <div className="absolute z-10 hidden lg:block" style={{ width: '600px', height: '691px', top: '90px', left: '705px' }}>
          <Image src={pinguinImg} alt="Doscom Mascot" fill className="object-contain" priority />
        </div>
      </div>
    </main>
  );
