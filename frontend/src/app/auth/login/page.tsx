  ...
  return (
    <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white p-6 md:p-10">
      ...
      <div className="absolute bottom-0 left-0 z-0 pointer-events-none select-none">
        <Image src="/bunder.png" alt="Circle Decoration" width={500} height={500} className="w-72 object-contain opacity-90 md:w-125" priority />
      </div>

      <div className="absolute top-0 right-24 z-20 pointer-events-none select-none">
        <Image src="/kembang.png" alt="Flower Decoration" width={256} height={256} className="w-40 object-contain opacity-90 md:w-64" priority />
      </div>
      ...
      <div className="relative z-10 grid min-h-200 w-full max-w-331 grid-cols-1 items-center rounded-[60px] border border-white/20 bg-white/30 shadow-2xl shadow-blue-100/20 backdrop-blur-[50px] lg:grid-cols-2">
        ...
        <div className="flex h-full w-full flex-col justify-center px-10 py-10 lg:pl-25 lg:pr-10">
          ...
          <div className="flex w-full max-w-[434.4px] flex-col gap-9.5">
            <div className="text-center lg:text-left">
              <h1 className="text-[32px] font-bold leading-tight text-black">Welcome to Doscom University</h1>
              <p className="mt-4 text-[16px] text-[#333333] opacity-80">Doscom University is one of DOSCOM's open source intensive training programs (bootcamps).</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="flex items-center gap-1">
                ...
                <a href="/auth/register" className="text-[18.15px] text-[#1F84E6] hover:underline">
                  Register for free
                </a>
              </div>
            </div>
        ...
        <div
          ...
          <Image src="/shuriken.png" alt="Shuriken Decoration" width={200} height={200} className="object-contain drop-shadow-[0_0_15px_rgba(37,130,225,0.6)]" />
        </div>
        ...
        <div
          ...
          <Image src="/pinguin.png" alt="Doscom Mascot" width={600} height={691} className="object-contain" priority />
        </div>
      </div>
    </main>
  )
