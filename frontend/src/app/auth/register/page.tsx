  ...
  return (
    <main className="relative flex min-h-screen w-full items-center justify-center overflow-x-hidden bg-white p-4 md:p-6">
      ...
      <div className="absolute bottom-0 left-0 z-0 pointer-events-none select-none">
        <Image src="/bunder.png" alt="Circle Decoration" width={500} height={500} className="w-48 md:w-72 lg:w-125 object-contain opacity-90" priority />
      </div>

      {/* Kembang */}
      <div className="absolute top-0 -right-5 md:right-24 z-20 pointer-events-none select-none">
        <Image src="/kembang.png" alt="Flower Decoration" width={256} height={256} className="w-24 md:w-40 lg:w-64 object-contain opacity-90" priority />
      </div>
      ...
      <div className="relative z-10 w-full max-w-360 flex items-center justify-center lg:justify-start lg:px-10">
          ...
          <div className="flex w-full flex-col gap-5 h-full justify-center">
            ...
            <div className="flex flex-col gap-2 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-3">
                <Image src={'/logo.png'} alt="Doscom Logo" width={26.7} height={25.35} className="object-contain" />
                <h1 className="text-[18.13px] font-bold text-[#0A84DC]">Doscom University</h1>
              </div>
              <p className="text-[14px] lg:text-[15px] font-normal text-black leading-relaxed">Doscom University is one of DOSCOM's open source intensive training programs (bootcamps).</p>
            </div>
            ...
            <form className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3 mt-1">
                <div className="flex items-center gap-2">
                  ...
                  <label htmlFor="remember" className="text-[12px] text-[#2D3748]">
                    Remember me
                  </label>
                </div>
                <div className="flex items-center gap-2">
        ...
        <div
          ...
          <Image src="/shuriken.png" alt="Shuriken Decoration" width={170} height={170} className="object-contain drop-shadow-[0_0_15px_rgba(37,130,225,0.6)]" />
        </div>
        ...
        <div
          ...
          <Image src="/pinguin.png" alt="Doscom Mascot" width={577} height={668} priority className="object-contain" />
        </div>
      </div>
    </main>
  )
