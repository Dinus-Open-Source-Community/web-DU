    ...
    <section className="bg-muted relative h-full min-h-screen w-full pt-20 pb-10">
      <div className="relative container mx-auto h-full w-full px-10">
        ...
        <div className="h-full w-full pt-20 text-center">
          <h1 className="mb-5 text-5xl leading-[1.3] font-bold">
            Explore Open Source Course
          </h1>
          ...
          {filter.map((f) => {
            ...
            return (
              <button
                ...
                className={`border-primary rounded-2xl border px-6 py-3 transition-colors ${
                  isCurrentActive
                    ? "bg-primary text-white"
                    : "text-primary bg-transparent"
                }`}
              >
                <h3 className="justify-center text-center align-middle text-xl font-normal">
                  {f.name}
                </h3>
              </button>
            );
        ...
        <div className="mt-12 flex h-full w-full">
          ...
          <div className="mr-4 h-full w-full max-w-[22%] rounded-xl bg-white p-8">
            <h2 className="mb-7 text-[28px] font-semibold tracking-tight text-black">
              Categories
            </h2>
