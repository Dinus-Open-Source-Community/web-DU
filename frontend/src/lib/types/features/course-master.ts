import type { ICategoryItem, ICourseTypeItem } from '../data/course'
...
export interface ICourseMasterFormValues {
  name: string
  description: string
  isActive: boolean
}

export const EMPTY_COURSE_MASTER_FORM: ICourseMasterFormValues = {
  name: '',
  description: '',
  isActive: true,
}

export interface ICreateCourseMasterPayload {
  name: string
  description?: string
  is_active?: boolean
}

export interface IUpdateCourseMasterPayload {
  name?: string
  description?: string
  is_active?: boolean
}

export interface ICourseMasterLabels {
  singular: string
  plural: string
  pageTitle: string
  pageSubtitle: string
...
export const COURSE_MASTER_LABELS: Record<CourseMasterKind, ICourseMasterLabels> = {
  category: {
    singular: 'Kategori',
...
export type CourseMasterFormValues = ICourseMasterFormValues
export type CreateCourseMasterPayload = ICreateCourseMasterPayload
export type UpdateCourseMasterPayload = IUpdateCourseMasterPayload
export type CourseMasterLabels = ICourseMasterLabels
