import type { DeadlineUrgency, IMentorAssignmentStats, IMentorAssignmentSubmission, IMentorCourseAssignment, MentorAssignmentLifecycleStatus } from '@/lib/types'
import { isMockDataEnabled } from '@/lib/config/mock-data'
import { getMergedMentorCourses } from '@/lib/mentorCourseStorage'
import { listMentorAssignmentSeeds, listMentorSubmissionSeeds } from '@/lib/data/repository'
...
export const ASSIGNMENT_SEED: IMentorCourseAssignment[] = listMentorAssignmentSeeds()
...
export const SUBMISSION_SEED: IMentorAssignmentSubmission[] = listMentorSubmissionSeeds()
